...
# The 'learning_log' directory contains four files (line 8); the most important are 'settings.py', 'urls.py', 'wsgi.py'. The settings.py file controls how Django interacts with your system and manages your project. We'll modify a few of these settings and add some settings of our own as the project evolves. The 'urls.py' file tells Django which pages to build in response to browser requests. The wsgi.py file helps Django serve the files it creates. The filename is an acronym for 'web server gateway interface'.